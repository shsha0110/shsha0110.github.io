---
title: "[Causal Inference] General Identifiability with Partial Observation (GID-PO)"
description: "서로 다른 변수 집합을 가진 여러 데이터셋을 결합하여 인과 효과를 추정하는 방법: 데이터 융합(Data Fusion) 문제의 해결"
author: "유성현"
date: "2026-01-25"
categories: [Causal Inference, Data Science, Econometrics]
format:
  html:
    toc: true
