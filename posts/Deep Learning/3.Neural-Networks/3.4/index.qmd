...
![Figure 1: Fully-Connected 계층과 Convolutional 계층에서의 Batch Normalization 적용 방식 비교 도식. FC 네트워크는 1D 벡터에 대해 정규화를 수행하는 반면, Conv 네트워크는 공간적 차원(H, W)을 보존한 3D 텐서에 대해 채널(C) 단위로 Spatial Batchnorm을 수행하는 과정을 수식 기호와 함께 대조적으로 보여줍니다.](./images/bn_fc_vs_conv.png)
