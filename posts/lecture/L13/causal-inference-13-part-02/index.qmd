...
* 이들은 $Z=0$일 때 $X=0$인 **Complier**와 **Never-taker**로 구성됩니다.
$$
...
* Complier라면 처치를 받았을 것이므로, 이 그룹은 순수하게 **Never-taker**들입니다.
$$
...
* Complier라면 처치를 안 받았을 것이므로, 이 그룹은 순수하게 **Always-taker**들입니다.
$$
...
* 이들은 $Z=1$일 때 $X=1$인 **Complier**와 **Always-taker**로 구성됩니다.
$$
