...
이번 강의(Part 1 & 2)를 통해 Convex Analysis의 기초인 **Set**과 **Function**을 정의했습니다.

1.  **Convex Set:** 두 점을 잇는 선분이 집합 안에 포함됨. (Affine, Conic 등과의 관계 파악 중요)
2.  **Convex Function:** 정의역이 Convex Set이고, Jensen's Inequality를 만족함.
3.  **관계:**
    * $f$ Convex $\iff$ Epigraph가 Convex Set.
    * $f$ Convex $\implies$ Level Set이 Convex Set (역은 성립 X).

이러한 성질들은 이후 **Convex Optimization Problem**을 정의하고, *Dual Problem*을 유도하며, *Optimality Condition*을 찾는 데 핵심적인 역할을 합니다.